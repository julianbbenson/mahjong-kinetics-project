...
But in the 1920s, the game jumped the pond to Japan. And in the gambling parlors of the post-war Showa era, the game underwent a violent, high-stakes mutation: the introduction of the *Riichi* declaration. 
...
**The Verdict:** The math dictates that early Riichi (Turns 1-5) is the only time the enzyme operates efficiently. If you are past Turn 8, your enzyme is dead. Fold the hand.
...
*(Aren't I great with names? Just imagine ol' Wald here glowing and floating. I'd thought of a Casper joke but forgot it...)*
...
If you’re new to Mahjong, don't let the "Rule of 64" scare you off. The math describes the boundaries of the cage, but the fun is in how you navigate it. Go play a game. Get on [Tenhou](https://tenhou.net/), feel the "conformational breathing" of your own hand, and see if you can beat the kinetics. 
